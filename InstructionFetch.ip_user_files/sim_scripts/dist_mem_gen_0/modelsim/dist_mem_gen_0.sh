...
#
# Script generated by Vivado on Sun Mar 09 13:26:22 EET 2025
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/pconstant/Undergrad/semester_6/eca302/SingleCycleProcessor/InstructionFetch/InstructionFetch.cache/compile_simlib/modelsim"
  fi
